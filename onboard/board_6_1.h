...
#define SDIO_DETECT_EXTI_LINE		    EXTI_Line11
...
// Not used ?
#define PX4_SPI_EXT_PORT           GPIOE
#define PX4_SPI_EXT_SCK_PIN        GPIO_Pin_2
#define PX4_SPI_EXT_NSS_PIN        GPIO_Pin_4
...
// SPI1
//
// GYO,BARO,MPU,ACCE_MAG Sensors are connected to SPI1
//
#define PX4_SENSORS_SPI       SPI1
#define SPI_SPI1_CLOCK        RCC_APB2Periph_SPI1
#define SPI_SPI1_AF           GPIO_AF_SPI1
#define SPI_SPI1_SCK_PORT     GPIOA
#define SPI_SPI1_MISO_PORT    GPIOA
...
// GYRO: L3GD20/L3GD20H
#define PX4_GYRO_SPI_CS_PORT         GPIOC          
#define PX4_GYRO_SPI_CS_PIN          GPIO_Pin_13
//External interrupts 
#define PX4_GYRO_EXTI_INT_PORT       GPIOB
#define PX4_GYRO_EXTI_INT_PIN        GPIO_Pin_0
#define PX4_GYRO_EXTI_DRDY_PORT      EXTI_PortSourceGPIOB
#define PX4_GYRO_EXTI_DRDY_PIN       EXTI_PinSource0
#define PX4_GYRO_EXTI_DRDY_LINE      EXTI_Line0
#define PX4_GYRO_EXTI_DRDY_IRQ       EXTI0_IRQn
#define PX4_GYRO_EXTI_DRDY_ISR       EXTI0_IRQHandler

// ACCEL_MAG: LSM303D
#define PX4_ACCEL_MAG_SPI_CS_PORT    GPIOC          
#define PX4_ACCEL_MAG_SPI_CS_PIN     GPIO_Pin_15
//External interrupts 
#define PX4_MAG_EXTI_INT_PORT        GPIOB 
#define PX4_MAG_EXTI_INT_PIN         GPIO_Pin_1
#define PX4_MAG_EXTI_DRDY_PORT       EXTI_PortSourceGPIOB
#define PX4_MAG_EXTI_DRDY_PIN        EXTI_PinSource1
#define PX4_MAG_EXTI_DRDY_LINE       EXTI_Line1
#define PX4_MAG_EXTI_DRDY_IRQ        EXTI1_IRQn
#define PX4_MAG_EXTI_DRDY_ISR        EXTI1_IRQHandler
//External interrupts 
#define PX4_ACCEL_EXTI_INT_PORT      GPIOB 
...
#define COMM_PORT1		    USART2  // TELEM1 Serial Port 1
//#define COMM_PORT2		    USART3  // TELEM2 Serial Port 2
//#define COMM_PORT3       	    UART4   // GPS    Serial Port 3
//#define COMM_PORT4       	    USART6  // Serial Port 4, Interface between PX4FMU and PX4IO
//#define COMM_PORT5      	    UART7   // Serial Port 5

#define COMM_DISABLE_FLOW_CONTROL3
#define COMM_DISABLE_FLOW_CONTROL4
#define COMM_DISABLE_FLOW_CONTROL5
...
#define SERIAL_UART2_TX_DMA_ST	DMA1_Stream6              //DMA2_Stream7
#define SERIAL_UART2_RX_DMA_CH	DMA_Channel_4
#define SERIAL_UART2_TX_DMA_CH	DMA_Channel_4
#define SERIAL_UART2_TX_DMA_IT	DMA1_Stream6_IRQHandler   //DMA2_Stream7_IRQHandler
...
//#define SERIAL_UART4_CTS_PIN	
//#define SERIAL_UART4_RTS_PIN	
#define SERIAL_UART4_RX_SOURCE	GPIO_PinSource1
#define SERIAL_UART4_TX_SOURCE	GPIO_PinSource0
//#define SERIAL_UART4_CTS_SOURCE	
//#define SERIAL_UART4_RTS_SOURCE	



// COMM_PORT4 USART6
// Interface between PX4FMU and PX4IO
/*
...
#define STM32_IRQ_USART6 (STM32_IRQ_INTERRUPTS+71) 
...
#define SERIAL_UART6_RX_DMA_ST	DMA2_Stream2
#define SERIAL_UART6_TX_DMA_ST	DMA2_Stream7
#define SERIAL_UART6_RX_DMA_CH	DMA_Channel_5
#define SERIAL_UART6_TX_DMA_CH	DMA_Channel_5
#define SERIAL_UART6_TX_DMA_IT	DMA2_Stream7_IRQHandler
#define SERIAL_UART6_TX_IRQn	DMA2_Stream7_IRQn     // If failed, try: USART6_IRQn   = 71,    // USART6 global interrupt 
#define SERIAL_UART6_RX_TC_FLAG	DMA_FLAG_TCIF2
#define SERIAL_UART6_RX_HT_FLAG	DMA_FLAG_HTIF2
#define SERIAL_UART6_RX_TE_FLAG	DMA_FLAG_TEIF2
#define SERIAL_UART6_RX_DM_FLAG	DMA_FLAG_DMEIF2
#define SERIAL_UART6_RX_FE_FLAG	DMA_FLAG_FEIF2
#define SERIAL_UART6_TX_TC_FLAG	DMA_FLAG_TCIF7
#define SERIAL_UART6_TX_HT_FLAG	DMA_FLAG_HTIF7
#define SERIAL_UART6_TX_TE_FLAG	DMA_FLAG_TEIF7
#define SERIAL_UART6_TX_DM_FLAG	DMA_FLAG_DMEIF7
#define SERIAL_UART6_TX_FE_FLAG	DMA_FLAG_FEIF7

// COMM_PORT5 UART7
#define SERIAL_UART7_PORT	GPIOE
#define SERIAL_UART7_RX_PIN	GPIO_Pin_7
#define SERIAL_UART7_TX_PIN	GPIO_Pin_8
//#define SERIAL_UART7_CTS_PIN	
//#define SERIAL_UART7_RTS_PIN	
#define SERIAL_UART7_RX_SOURCE	GPIO_PinSource7
#define SERIAL_UART7_TX_SOURCE	GPIO_PinSource8
//#define SERIAL_UART7_CTS_SOURCE	
//#define SERIAL_UART7_RTS_SOURCE	
