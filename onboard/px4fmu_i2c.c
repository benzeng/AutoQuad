...
#undef CONFIG_STM32_I2CTIMEOTICKS
...
struct stm32_i2c_priv_s
{
    ...
    OS_EventID sem_excl;         /* Mutual exclusion semaphore */
#ifndef CONFIG_I2C_POLLED
    OS_EventID sem_isr;          /* Interrupt wait semaphore */
#endif
...
static struct stm32_i2c_inst_s _stm32_i2c_inst_s[3];
...
static inline void stm32_i2c_sem_wait(FAR struct i2c_dev_s *dev)
{
    ...
    while (CoPendSem(((struct stm32_i2c_inst_s *)dev)->priv->sem_excl,0) != E_OK)
    {
        ;//ASSERT(errno == EINTR);
    }
}
...
static inline int stm32_i2c_sem_waitdone(FAR struct stm32_i2c_priv_s *priv, int timeout_us)
{
    ...
    do
    {
        ...
        tv_m_sec = CONFIG_STM32_I2CTIMEOSEC * 1000;
#endif
        ...
        tv_m_sec += (CONFIG_STM32_I2CTIMEOUS_PER_BYTE/1000 * bytecount);
/*        
...
*/
	...
	tv_m_sec += CONFIG_STM32_I2CTIMEOMS;
/*
...
*/
        ...
        ret = CoPendSem( priv->sem_isr, MSEC2TICK(tv_m_sec) );
	if (ret != E_OK )
        {
...
static inline void stm32_i2c_sem_post(FAR struct i2c_dev_s *dev)
{
    ...
    CoPostSem( ((struct stm32_i2c_inst_s *)dev)->priv->sem_excl );
}
...
static inline void stm32_i2c_sem_init(FAR struct i2c_dev_s *dev)
{
    ((struct stm32_i2c_inst_s *)dev)->priv->sem_excl = CoCreateSem(1,1,EVENT_SORT_TYPE_FIFO);

//    sem_init(&((struct stm32_i2c_inst_s *)dev)->priv->sem_excl, 0, 1);
#ifndef CONFIG_I2C_POLLED
    //sem_init(&((struct stm32_i2c_inst_s *)dev)->priv->sem_isr, 0, 0);
    ((struct stm32_i2c_inst_s *)dev)->priv->sem_isr = CoCreateSem(1,1,EVENT_SORT_TYPE_FIFO);
#endif
}
